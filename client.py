...
from routing.shared.utility.logging import Logger
...
stub = routing_pb2_grpc.UserControllerStub(channel)
...
def fetch_data():
    ...
    try:
        array = []
        try:
            user = stub.List(routing_pb2.UserListRequest())
...
# for create the data 
response = stub.Create(routing_pb2.User(id= 6,name = "iuhuhu",email = "tej@gmail.com", groups = "carss" ))
print(response)

# a = routing_pb2.User(id= 3,name = "finallllll",email = "pkk@gmail.com", groups = "pop" )
# print(a, "aaaa")
# stub.Update(a)


# for delete 
# a = stub.Destroy(routing_pb2.User(id=3))
# print(a)

# retrieve on the basis of the id 
a =routing_pb2.UserRetrieveRequest(id = 3)
print(a)
